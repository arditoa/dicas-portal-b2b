...
const GASTRONOMY_DATA = [
  {
    ...
    distance: '800m',
    rating: '4.9',
    coupon: 'Double chopp para membros',
    badge: 'LGBT+ Friendly',
    instagram: '@barcastrosp',
    color: '#E1306C',
  },
  {
    id: 'cafe-safado',
    ...
    rating: '4.8',
    badge: 'LGBT+ Friendly',
    instagram: '@cafesafado',
    color: '#FFB74D',
  },
  {
    id: 'bistro-das-cores',
    name: 'Bistrô das Cores',
    category: 'restaurantes',
    typeLabel: 'Restaurante',
    neighborhood: 'Pinheiros',
    distance: '2.1km',
    rating: '5.0',
    coupon: '10% de desconto no prato principal',
    badge: 'LGBT+ Friendly',
    instagram: '@bistrodascores',
    color: '#4FC3F7',
  },
];

export default function GastronomyCategoryScreen() {
  const router = useRouter();
  const [selectedSub, setSelectedSub] = useState('all');

  const filteredData = selectedSub === 'all'
    ? GASTRONOMY_DATA
    : GASTRONOMY_DATA.filter(item => item.category === selectedSub);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.titleRow}>
          <View style={styles.categoryIconBadge}>
            <Feather name="coffee" size={16} color="#FFB74D" />
          </View>
      ...
      <Text style={styles.resultCount}>{filteredData.length} resultados em Gastronomia</Text>
